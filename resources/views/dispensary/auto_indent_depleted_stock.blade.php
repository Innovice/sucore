            ...
            <form class="form-horizontal">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control" id="reqid" placeholder="Enter Requisition ID" name="dispensary_reqid">
                      </div>
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control" id="medidesc" placeholder="Enter Medicine description" name="dispensary_medidesc">
                      </div>

                      <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">QUANTITY REQUIRED</label>
                      <div class="col-sm-9">
                          <input type="number" class="form-control" id="qtyreqd" name="dispensary_reqd_qty">
                      </div>

                      <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">BALANCE IN HAND</label>
                      <div class="col-sm-9">
                          <input type="number" class="form-control" id="balance" name="dispensary_balance">
                      </div>
                      ...
                      <div class="col-sm-9">
                          <input type="number" class="form-control" id="suppqty" name="dispensary_lastsupp_qty">
                      </div>
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control" id="requno" name="dispensary_lastsupp_reqno">
                      </div>
                      ...
                      <div class="col-sm-9">
                          <input type="date" class="form-control" id="lastreqdate" name="dispensary_lastreq_dt">
                      </div>

                      <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">DATE OF REQUISITION</label>
                      <div class="col-sm-9">
                          <input type="date" class="form-control" id="reqdate" name="dispensary_req_dt">
                      </div>
