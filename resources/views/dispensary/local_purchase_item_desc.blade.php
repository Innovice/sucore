            ...
            <form class="form-horizontal">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">MEDICINE NAME</label>
                        <div class="col-sm-9">
                          <input type="text" step="0.01" class="form-control" id="fname" placeholder="Enter Medicine name">
                        </div>
                        ...
                        <div class="col-sm-9">
                            <input type="number" step="0.01" class="form-control" id="fname" placeholder="Enter quantity">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">APPROX UNIT COST</label>
                        <div class="col-sm-9">
                            <input type="number" step="0.01" class="form-control" id="fname" placeholder="Enter Approx unit cost">
                        </div>
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">APPROX TOTAL COST</label>
                        <div class="col-sm-9">
                            <input type="number" step="0.01" class="form-control" id="fname" placeholder="Enter Approx totsl cost">
                        </div>
                    </div>
