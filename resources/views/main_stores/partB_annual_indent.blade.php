            ...
            <form class="form-horizontal">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom: 4px;">CODE OF ITEM</label>
                        <div class="col-sm-9">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="fname" placeholder="Enter Item name">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom: 4px;">SPECIFICATION</label>
                        <div class="col-sm-9">
                            <input type="text" min="1990" max="2100" class="form-control" id="fname" placeholder="Enter Item sub Type">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom: 4px;">PACKAGE IN UNIT</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="fname" placeholder="Enter Package in Unit">
                        </div>
                        ...
                        <div class="col-sm-9">
                            <input type="number" min="1990" max="2100" class="form-control" id="fname" placeholder="Enter unit cost per item">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom: 4px;">QUANTITY PER UNIT</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="fname" placeholder="Enter quantity per unit">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom: 4px;">MONTHLY CONSUMPTION</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="fname" placeholder="Enter monthly comsumption">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom: 4px;">QTY REQUIRED FOR 12 MONTHS</label>
                        <div class="col-sm-9">
                            <input type="number" min="1990" max="2100" class="form-control" id="fname" placeholder="Enter quantity required for 12 months">
                        </div>
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="fname" placeholder="Enter total estimation cost">
                        </div>
                        ...
                        <div class="col-sm-9">
                            <input type="text" min="1990" max="2100" class="form-control" id="fname" placeholder="Describe Justificaion">
                        </div>
                    </div>
