            ...
            <form class="form-horizontal">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="fname" placeholder="Type indent no. here">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px"  disabled>ITEM</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="fname" placeholder="Type item here">
                        </div>
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="fname" placeholder="Enter requested quantity here">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">QUANTITY ORDERED</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="fname" placeholder="Type ordered quantity here">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">PO NUMBER</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="fname" placeholder="Type Purchase Order number here">
                        </div>
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="fname" placeholder="Select last date of Purchase Order here">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">UNIT COST</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="fname" placeholder="Enter unit cost here">
                        </div>
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="fname" placeholder="Enter total cost with out GST here">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">GST PERCENTAGE</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="fname" placeholder="Type GST Percentage here">
                        </div>
