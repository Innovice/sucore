            ...
            <form class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" step="0.01" class="form-control" id="fname" placeholder="Enter balancet to be procured">
                    </div>
                    ...
                    <div class="col-sm-9">
                        <input type="text"class="form-control" id="fname" placeholder="Enter last PO number">
                    </div>
                    <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom: 4px;">DATE_OF_LAST_PO</label>
                    <div class="col-sm-9">
