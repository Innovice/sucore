    ...
    <div class="col-md-12">
        <div class="card">
            <form class="form-horizontal">
                <div class="card-body">
                    <h4 class="card-title">Receipt of purchase orders of Items</h4>
                    <div class="form-group row">
                        ...
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px"  disabled>QUANTITY ORDERED</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="qtyordered" name="nms_qtyordered" placeholder="Type Ordered Quantity here">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">PO NUMBER</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="ponumber" name="nms_ponumber" placeholder="Type PO number here">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">NAME OF PARTY</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="partyname" name="nms_partyname" placeholder="Type Name here">
                        </div>
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="manfname" name="nms_manfname" placeholder="Type Name here">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">LAST DATE OF PO</label>
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="podate" name="nms_podate" placeholder="Type Last Date of PO here">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">UNIT COST</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="itemunitcost" name="nms_itemunitcost" placeholder="Type Unit Cost of Item here">
                        </div>
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="costwogst" name="nms_costwogst" placeholder="Type Total Cost Without GST here">
                        </div>

                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">GST PERCENTAGE</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="gstpercentage" name="nms_gstpcng" placeholder="Type GST Percentage here">
                        </div>
                        ...
                        <div class="col-sm-9">
                          <select class="form-control" name="nms_gsttype">
