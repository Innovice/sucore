    ...
    <div class="col-md-12">
        <div class="card">
            <form class="form-horizontal">
                <div class="card-body">
                    <h4 class="card-title">Indent for Dispatch items (WARDS/PATIENTS/DISPENSARY)</h4>
                    <div class="form-group row">
                        ...
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px"  disabled>BALANCE</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="fname">
                        </div>
                        ...
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom:5px">WARD NAME</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="fname">
                        </div>
