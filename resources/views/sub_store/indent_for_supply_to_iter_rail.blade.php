    ...
    <div class="col-md-12">
        <div class="card">
            <form class="form-horizontal">
                <div class="card-body">
                    <h4 class="card-title">Indent for supply of Medicines(Inter and Intra Railways)</h4>
                    <div class="form-group row">
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom: 4px;">NAME OF RAILWAYS</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="fname" placeholder="Enter name of Railways">
                        </div>
                        ...
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom: 4px;">NAME OF MEDICINES</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="fname" placeholder="Enter name of Medicines">
                        </div>
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="fname" placeholder="Enter Expiry date">
                        </div>
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom: 4px;">MANUFACTURE DATE</label>
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="fname" placeholder="Enter manufacture date">
                        </div>
