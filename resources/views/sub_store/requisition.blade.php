            ...
            <form class="form-horizontal">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label" style="margin-bottom: 4px;">REQUISITION_DESC</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="fname" placeholder="Enter Requisition Description">
                        </div>
                    </div>
